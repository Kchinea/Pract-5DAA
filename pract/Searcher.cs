...
public class Searcher {
  ...
  public Solution Run(Solution solution, Instance instance) {
    ...
    solution = _localSearches[0].Solve(solution, instance.Zones);
    solution = _localSearches[1].Solve(solution, instance.Zones);
    solution = _localSearches[2].Solve(solution, instance.Zones);
    solution = _localSearches[3].Solve(solution, instance.Zones);
    return solution;
}
